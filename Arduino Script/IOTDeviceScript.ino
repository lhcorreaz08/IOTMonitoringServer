...
const char ssid[] = "CORREA-SALAZAR"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "fito98176284"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "54.236.242.76"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
const int MQTT_PORT = 8082;
const char MQTT_USER[] = l.correaz;
// Contraseña de MQTT
const char MQTT_PASS[] = "Fito123456"; // TODO Reemplace ContrasenaMQTT por la contraseña correpondiente al usuario especificado.
...
// Pin para la luz
const int luzPin = 5; // Cambia el número del pin según la conexión de tu hardware
bool luzEncendida = false; // Variable para controlar el estado de la luz
...
void receivedCallback(char* topic, byte* payload, unsigned int length) {
  ...
  if (data.indexOf("ALERT") >= 0) {
    alert = data;
  } else if (data == "ENCENDER_LUZ") {
    encenderLuz();
    alert = "Luz encendida.";
  } else if (data == "APAGAR_LUZ") {
    apagarLuz();
    alert = "Luz apagada.";
  }
}
